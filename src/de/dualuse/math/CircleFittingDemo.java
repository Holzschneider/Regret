...
//			error += pow(pow(pow(y-cy,2)+pow(x-cx,2),1.0/2.0)-r,2) ;
	...
	protected double[] e_(double[] params, double[] values) {
		...
		for (int i=0,I=n();i<I;i++) {
			...
			double  v1 = x-cx,
				v2 = y-cy,
				v3 = Math.sqrt(Math.pow(v2,2d)+Math.pow(v1,2d)),
				v4 = 1d/v3,
				v5 = v3-r,
				e_[] = {-2d*v1*v4*v5,-2d*v2*v4*v5,-2d*v5}; 
	...
	protected double[][] e__(double[] params, double[][] values) {
		...
		for (int i=0,I=n();i<I;i++) {
			...
			double  v1 = x-cx,
				...
				v6 = 1d/v5,
				v7 = Math.sqrt(v5),
				v8 = 1d/Math.pow(v7,3d),
				v9 = v7-r,
				v10 = 1d/v7,
				v11 = 2d*v10*v9,
				v12 = 2d*v1*v3*v6-2d*v1*v3*v8*v9,
				v13 = 2d*v1*v10,
				v14 = 2d*v3*v10,
				e__[][] = 	{{v11-2d*v2*v8*v9+2d*v2*v6,v12,v13},
						 {v12,v11-2d*v4*v8*v9+2d*v4*v6,v14},
						 {v13,v14,2d}}; 
